...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  6 13:10:08 2020
...
def plot_confusion_matrix_from_data(y_test, predictions,num_classes,columns=None, annot=True, cmap="Oranges",
    ...
    confm=np.zeros((num_classes,num_classes))
    for i in range(len(y_test)):
        confm[int(y_test[i]),int(predictions[i])]=confm[int(y_test[i]),int(predictions[i])]+1
    confm = confm.astype(int)
