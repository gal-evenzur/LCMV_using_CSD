...
for i=1:5
    ...
    for j=1:num_jumps
        ...
        path = strcat('C:\project\TIMIT CD\TIMIT\test\',male_female2,'\',male_female2,'_',source2);
        f=dir([path '\*.wav']);
        folder=f.folder;
        num_file = randi(10);
        file=f(num_file).name;
...
%% create input
    ...
    data_first=sprintf('C:\\project\\val_dynamic\\first_%d.wav',i);
    data_second=sprintf('C:\\project\\val_dynamic\\second_%d.wav',i);
    data_noise=sprintf('C:\\project\\val_dynamic\\noise_%d.wav',i);
    data_together=sprintf('C:\\project\\val_dynamic\\together_%d.wav',i);
    ...
    label_first_location_file=sprintf('C:\\project\\val_dynamic\\label_location_first_%d.mat',i);
    label_second_location_file=sprintf('C:\\project\\val_dynamic\\label_location_second_%d.mat',i);
    save(label_first_location_file,'vad_first_speaker')
    save(label_second_location_file,'vad_second_speaker')
    
    mic_array_file=sprintf('C:\\project\\val_dynamic\\mic_array_%d.mat',i);
