...
for i=1:500
    ...
    for j=1:num_jumps
        ...
        path = strcat('C:\project\TIMIT CD\TIMIT\data_base\',male_female1,'\',source1);
        f=dir([path '\*.wav']);
        folder=f.folder;
        num_file = randi(10);
        ...
        path = strcat('C:\project\TIMIT CD\TIMIT\data_base\',male_female2,'\',source2);
        f=dir([path '\*.wav']);
        folder=f.folder;
        num_file = randi(10);
        file=f(num_file).name;
...
%% create input
    ...
    data_first=sprintf('C:\\project\\DB_dynamic\\first_%d.wav',i);
    data_second=sprintf('C:\\project\\DB_dynamic\\second_%d.wav',i);
    data_noise=sprintf('C:\\project\\DB_dynamic\\noise_%d.wav',i);
    data_together=sprintf('C:\\project\\DB_dynamic\\together_%d.wav',i);
    ...
    label_first_location_file=sprintf('C:\\project\\DB_dynamic\\label_location_first_%d.mat',i);
    label_second_location_file=sprintf('C:\\project\\DB_dynamic\\label_location_second_%d.mat',i);
